CREATE TABLE matches (id VARCHAR(36) NOT NULL PRIMARY KEY, match_date TIMESTAMP, team_a_id VARCHAR(36), team_a_name VARCHAR(255), team_b_id VARCHAR(36), team_b_name VARCHAR(255), result VARCHAR(255));
